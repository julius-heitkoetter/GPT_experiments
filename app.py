...
with block:
    with gr.Row():
        gr.Markdown("<h3><center>Rockwell Trading Chatbot (V0.1.0)</center></h3>")
    ...
    with gr.Row():
        message = gr.Textbox(
            ...
            placeholder="Ask questions about stocks, options, or anything else from Markus' content",
            lines=1,
        )
    ...
    gr.Examples(
        examples=[
            "What is a stop loss?",
            "How do I know when to leave a trade according to the Wheel?",
            "What are the steps to becoming a sucsessful trader?",
